...
const GAMES = [
  ...
  { id: 19, title: 'Mortal Kombat 1', platform: 'PC / PS5 / Xbox', genre: 'Fighting', rating: 4.4, price: 59.99, oldPrice: null, cover: 'assets/mp.png', tier: 'B', desc: 'A rebooted timeline reignites the franchise\u2019s brutal rivalries.', stock: 'out', featured: false, bestseller: null, newRelease: false, releaseDate: null },
  { id: 20, title: 'Horizon Forbidden West', platform: 'PS5 / PC', genre: 'RPG', rating: 4.6, price: 49.99, oldPrice: null, cover: 'assets/hr.png', tier: 'A', desc: 'Aloy ventures into a deadly frontier of machines and mystery.', stock: 'in', featured: false, bestseller: null, newRelease: false, releaseDate: null },
];
